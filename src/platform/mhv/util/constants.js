import { formatDateUtcLong } from '@department-of-veterans-affairs/platform-utilities/exports';
...
export const reportGeneratedBy = `Report generated by My HealtheVet on VA.gov on ${formatDateUtcLong()}`;
